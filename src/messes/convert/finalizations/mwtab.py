# -*- coding: utf-8 -*-
"""
Code for finalizing MWTab conversion.
"""
...
def finalization(output_json: dict, input_json_filepath: str, output_filename: str, sub_command: str) -> None:
    """
    """
    ...
    mwtabfile.source = input_json_filepath
